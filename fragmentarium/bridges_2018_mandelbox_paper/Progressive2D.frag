// tweaked from standard Progressive2D.frag mostly to get usable zoomscaled variable in frags that include Progressive2D
#donotrun
...
uniform float Zoom; slider[0,0.15,100] NotLockable
